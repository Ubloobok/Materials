...
| [55. Jump Game](https://leetcode.com/problems/jump-game/) | Iterate through the array, track max jump balance, i.e. the furthest reachable index as you move forward. | O(n) Time, O(1) Space | Evaluating if a sequence of steps or tasks can be completed in games or real-life project planning. |
|||||
